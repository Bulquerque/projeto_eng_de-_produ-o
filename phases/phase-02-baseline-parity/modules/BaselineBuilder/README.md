...
## O que faz
Constrói o objeto de cenário base a partir do input normalizado.

## Implementação real
`assets/js/phase2/baseline-builder.js`
...
## Debug
Abra `/debug/`, procure `BaselineBuilder` e rode os testes listados.
