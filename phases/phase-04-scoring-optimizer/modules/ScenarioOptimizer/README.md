...
## O que faz
Roda busca leve no navegador, simula candidatos, aplica restrições, normaliza métricas e ranqueia.
...
## Debug
Abra `/debug/`, procure `ScenarioOptimizer` e rode os testes listados.
