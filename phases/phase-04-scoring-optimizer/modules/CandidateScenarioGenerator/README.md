...
## O que faz
Gera candidatos automaticamente combinando CDs ativos, frete, estoque, demanda e modo tributário.
...
## Debug
Abra `/debug/`, procure `CandidateScenarioGenerator` e rode os testes listados.
