...
## O que faz
Executa testes automáticos da Fase 4 na interface.

## Implementação real
`assets/js/phase4/phase4-tests.js`
...
## Debug
Abra `/debug/`, procure `Phase4TestPanel` e rode os testes listados.
