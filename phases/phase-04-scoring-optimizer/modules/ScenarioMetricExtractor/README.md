...
## O que faz
Extrai métricas comparáveis dos cenários simulados: custo, qualidade, risco, tributo e eficiência de estoque.
...
## Debug
Abra `/debug/`, procure `ScenarioMetricExtractor` e rode os testes listados.
