...
Os dados-fonte permanecem criptografados no repositório. `.env.local` é local e ignorado; a senha nunca deve entrar no Git, em relatórios ou em artefatos de entrega.
