...
export function combineTransitionTaxes({ legacyResult = {}, reformResult = {}, regime = {} } = {}) {
  ...
  const reformWeight =
    regime.reform_weight != null ? n(regime.reform_weight, 1 - legacyWeight) : 1 - legacyWeight;
  ...
  return {
    ...
    tax_breakdown_by_destination_uf:
      ...
      legacyResult.tax_breakdown_by_destination_uf ||
      {},
    tax_breakdown_by_fiscal_category:
      reformResult.tax_breakdown_by_fiscal_category ||
      legacyResult.tax_breakdown_by_fiscal_category ||
      {},
  };
}
