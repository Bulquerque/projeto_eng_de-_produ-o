...
PATHS=[('/index.html', 'Simulador Est'), ('/assets/styles.css', '--vg-dark'), ('/assets/app.js', None), ('/data/catalog.json', 'empresa1'), ('/data/validation/path_resolution_report.json', 'missing_paths'), ('/fase-1-validacao/', 'Valida'), ('/debug/', 'Debug Center')]
OK_MESSAGE='PHASE1_HTTP_SERVER_OK'
