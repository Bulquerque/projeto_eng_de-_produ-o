...
PATHS=[('/fase-3-cenarios/', 'Fase 3'), ('/assets/js/phase3/main.js', 'phase3'), ('/data/empresa1/phase2/phase2_bundle.json.enc.json', 'ciphertext'), ('/data/empresa2/phase3/sample_scenarios.json.enc.json', 'ciphertext'), ('/debug/', 'Debug Center')]
