...
required = [
    ...
    'data/empresa1/core/demand_records.csv.enc.json',
    'data/empresa1/core/distance_matrix.csv.enc.json',
    'data/empresa1/core/premissas.csv.enc.json',
    'data/empresa2/core/faturamento_uf.csv.enc.json',
    'data/empresa2/core/distribuicao_fabrica_cd.csv.enc.json',
    'data/empresa2/core/scenario_blocks.json.enc.json',
]
