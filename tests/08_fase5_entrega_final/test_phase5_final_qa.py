...
for (const companyId of ['empresa1','empresa2']) {
 ...
 const selectedScenario={final_score:88, scenario_id:`${companyId}_fake`, result:{company_id:companyId, evidence:{evidence_score:80,components:[],blockers:[]}}, quality:{risk_level:'low'}};
