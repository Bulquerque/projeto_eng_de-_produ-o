...
PATHS=[('/fase-5-entrega-final/', 'Fase 5'), ('/assets/js/phase5/main.js', 'Phase5'), ('/assets/js/phase5/stress-test-engine.js', 'runStressTests'), ('/data/empresa1/phase2/phase2_bundle.json.enc.json', 'ciphertext'), ('/data/empresa2/phase2/phase2_bundle.json.enc.json', 'ciphertext'), ('/debug/', 'Debug Center')]
