...
if __name__ == '__main__':
    test_phase2_html_references_assets()
    test_phase2_css_components_exist()
    test_phase2_js_modules_exist_and_parse()
    test_no_absolute_runtime_paths_in_phase2()
    print('PHASE2_STATIC_SITE_OK')
