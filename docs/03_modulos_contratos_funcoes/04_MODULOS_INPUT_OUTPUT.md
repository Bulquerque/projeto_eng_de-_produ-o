...
2. `docs/03_modulos_contratos_funcoes/23_MODULOS_TODAS_FASES_CONTRATOS.md` — contrato completo de cada módulo.
...
5. `data/contracts/module-contracts.json` — versão estruturada dos contratos em JSON.
